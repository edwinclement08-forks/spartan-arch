...
mkdir Pictures
cd Pictures
wget https://github.com/edwinclement08/spartan-arch/blob/master/wallpaper.jpg?raw=true -O wallpaper.jpg
cd ~/.config/
mkdir nitrogen
cd nitrogen
...
cd
wget https://raw.githubusercontent.com/edwinclement08/spartan-arch/master/startx.sh -O startx.sh
chmod +x startx.sh
